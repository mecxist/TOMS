...
import { MapPin, CheckCircle2, Eye, Circle } from 'lucide-react';
    ...
    <div className="p-8 flex gap-6">
      ...
      <div className="w-[240px] flex-shrink-0">
        <div className="flex items-center justify-between mb-4">
          ...
          <button className="text-[#999] dark:text-[#888] hover:text-[#666] dark:hover:text-[#aaa] transition-colors">
          ...
          {openRoles.map((role) => (
            ...
            >
              ...
              <div className="flex items-center justify-between">
                <span className="text-[10px] text-[#999] dark:text-[#888] uppercase tracking-wide">{role.type}</span>
                <span className="bg-[#fef2f2] text-[#ef4444] text-[9px] font-medium px-1.5 py-0.5 rounded">
        ...
        <div className="mb-6 flex items-start justify-between">
          ...
          <div className="flex items-center gap-3">
            <div className="text-right">
              <div className="text-[10px] text-[#999] dark:text-[#888] uppercase tracking-wide mb-1">
                Confidence Threshold
              </div>
            ...
            >
              ...
              <div className="p-6 pb-5 border-b border-[rgba(0,0,0,0.05)] dark:border-[rgba(255,255,255,0.1)]">
                <div className="flex items-start justify-between mb-4">
                  <div className="flex items-center gap-3">
                    <div className="size-10 rounded-full bg-[#f5f5f5] dark:bg-[#2a2a2a] flex items-center justify-center text-sm font-medium text-[#666] dark:text-[#aaa]">
                      {candidate.initials}
                    </div>
                    <div>
                      <h3 className="text-sm font-semibold text-[#111] dark:text-[#e5e5e5]">{candidate.name}</h3>
                      <div className="flex items-center gap-1 text-[11px] text-[#999] dark:text-[#888] mt-0.5">
                  ...
                  <div className="flex flex-col items-end">
                    ...
                    <div className="text-[9px] text-[#999] dark:text-[#888] uppercase tracking-wider">Match</div>
                  </div>
                </div>

                {/* Progress Bar */}
                <div className="h-1.5 bg-[#f5f5f5] dark:bg-[#2a2a2a] rounded-full overflow-hidden mb-5">
                  <div
                ...
                {candidate.skillMatch && (
                  <div>
                    <div className="flex items-start gap-2 mb-2">
                      <div className="px-2 py-0.5 rounded text-[9px] font-medium uppercase tracking-wide bg-[#f5f5f5] dark:bg-[#2a2a2a] text-[#666] dark:text-[#aaa]">
                        Skill Match
                      </div>
                    </div>
                    <p className="text-[11px] text-[#666] dark:text-[#aaa] leading-relaxed">
