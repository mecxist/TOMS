      ...
      <div className="grid grid-cols-2 gap-6">
        ...
        <div>
          <div className="flex items-center justify-between mb-6">
            ...
            <button className="text-xs text-[#eb3a14] font-medium hover:underline">
              Approve All
            </button>
          </div>
        ...
        <div>
          <h2 className="text-base font-medium text-[#111] dark:text-[#e5e5e5] mb-6">
            Payroll Run (Stage 10)
          </h2>
          ...
          <div className="bg-white dark:bg-[#1e1e1e] rounded-lg border border-[rgba(0,0,0,0.05)] dark:border-[rgba(255,255,255,0.1)] p-6">
            ...
            <p className="text-xs text-[#666] dark:text-[#888] text-center mt-3">
              Next run scheduled: Nov 15
            </p>
          </div>
        </div>
      </div>
  ...
  return (
    <div className="bg-white dark:bg-[#1e1e1e] rounded-lg border border-[rgba(0,0,0,0.05)] dark:border-[rgba(255,255,255,0.1)] p-4 hover:shadow-md transition-shadow">
      <div className="flex items-start gap-3">
        <div
          className={`size-10 rounded-full flex items-center justify-center text-sm font-medium shrink-0 ${getColorClass(
            log.color
          )}`}
        >
          {log.initials}
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="flex items-center gap-2">
            <span className="bg-green-100 text-green-700 text-[10px] font-medium px-2 py-1 rounded">
              Contract Signed
            </span>
