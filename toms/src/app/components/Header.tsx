    ...
    <header className="bg-white dark:bg-[#1e1e1e] h-16 border-b border-[rgba(0,0,0,0.05)] dark:border-[rgba(255,255,255,0.1)] shrink-0 z-10">
      <div className="h-full px-8 flex items-center justify-between gap-8">
        ...
        <div className="flex items-center gap-3">
          <span className="text-xs text-[#999] dark:text-[#888]">TalentOS</span>
          <span className="text-xs text-[#999] dark:text-[#888]">/</span>
          <h1 className="text-xs text-[#111] dark:text-[#e5e5e5] font-medium">{title}</h1>
        </div>
        ...
        <div className="flex-1 max-w-md">
          <div className="relative">
            ...
            <div className="absolute right-3 top-1/2 -translate-y-1/2 flex items-center gap-1">
              <kbd className="px-1.5 py-0.5 bg-white dark:bg-[#333] border border-[rgba(0,0,0,0.1)] dark:border-[rgba(255,255,255,0.1)] rounded text-[10px] text-[#666] dark:text-[#aaa]">⌘</kbd>
              <kbd className="px-1.5 py-0.5 bg-white dark:bg-[#333] border border-[rgba(0,0,0,0.1)] dark:border-[rgba(255,255,255,0.1)] rounded text-[10px] text-[#666] dark:text-[#aaa]">K</kbd>
            </div>
          </div>
        </div>
        ...
        <div className="flex items-center gap-4">
          ...
          <button className="bg-[#111] dark:bg-white text-white dark:text-[#111] px-4 py-2 rounded-lg flex items-center gap-2 hover:bg-[#222] dark:hover:bg-[#e5e5e5] transition-colors">
