...
export default function TimesheetsPage() {
  const [currentWeek] = useState('Nov 20 - Nov 26, 2023')
  ...
  const weekData: DayEntry[] = [
    {
      ...
      day: 'Mon',
      entries: [
        { id: '1', project: 'TOMS Platform', task: 'Frontend Development', hours: 8, status: 'approved' },
      ],
      totalHours: 8,
    },
    {
      ...
      day: 'Tue',
      entries: [
        { id: '2', project: 'TOMS Platform', task: 'Frontend Development', hours: 6, status: 'approved' },
    ...
    },
    {
      ...
      day: 'Wed',
      entries: [
        { id: '4', project: 'TOMS Platform', task: 'API Integration', hours: 7, status: 'pending' },
      ],
      totalHours: 7,
    },
    { date: '23', day: 'Thu', entries: [], totalHours: 0 },
    { date: '24', day: 'Fri', entries: [], totalHours: 0 },
    { date: '25', day: 'Sat', entries: [], totalHours: 0 },
    { date: '26', day: 'Sun', entries: [], totalHours: 0 },
  ]
  ...
  const getStatusBadge = (status: string) => {
    switch (status) {
      ...
      case 'pending':
        return (
          <span className="inline-flex items-center gap-1 px-2 py-0.5 bg-[#fef3c7] dark:bg-yellow-900/30 text-[#d97706] dark:text-yellow-400 rounded text-[10px] font-medium">
      ...
      case 'rejected':
        return (
          <span className="inline-flex items-center gap-1 px-2 py-0.5 bg-[#fee2e2] dark:bg-red-900/30 text-[#dc2626] dark:text-red-400 rounded text-[10px] font-medium">
      ...
      <div className="p-8 bg-[#f5f5f5] dark:bg-[#2a2a2a] min-h-full">
        <div className="mb-6 flex items-center justify-between">
          <div>
            <div className="flex items-center gap-2 mb-2">
              ...
              <h2 className="text-lg font-semibold text-[#111] dark:text-[#e5e5e5]">Timesheets</h2>
            </div>
        ...
        <div className="grid grid-cols-4 gap-4 mb-6">
          ...
          <div className="bg-white dark:bg-[#1e1e1e] rounded-lg border border-[rgba(0,0,0,0.05)] dark:border-[rgba(255,255,255,0.1)] p-4">
            ...
            <div className="text-2xl font-bold text-[#059669] dark:text-green-400">16h</div>
          </div>
          <div className="bg-white dark:bg-[#1e1e1e] rounded-lg border border-[rgba(0,0,0,0.05)] dark:border-[rgba(255,255,255,0.1)] p-4">
            <div className="text-xs text-[#666] dark:text-[#888] mb-1">Pending</div>
            <div className="text-2xl font-bold text-[#d97706] dark:text-yellow-400">7h</div>
          </div>
          <div className="bg-white dark:bg-[#1e1e1e] rounded-lg border border-[rgba(0,0,0,0.05)] dark:border-[rgba(255,255,255,0.1)] p-4">
              ...
              >
                {day.entries.length > 0 ? (
                  <div className="p-3 space-y-2">
                    {day.entries.map((entry) => (
                      ...
                      >
                        ...
                        <div className="text-[10px] text-[#666] dark:text-[#aaa] mb-2 line-clamp-1">{entry.task}</div>
                  ...
                  <div className="h-full flex items-center justify-center p-4">
                    <button className="text-xs text-[#666] dark:text-[#888] hover:text-[#666] dark:hover:text-[#aaa] transition-colors">
                      + Add Entry
                    </button>
                  </div>
                )}
