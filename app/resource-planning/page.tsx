  ...
  const resources: Resource[] = [
    {
      ...
      projects: [
        { name: 'TOMS Platform', hours: 25, color: '#6366f1' },
    ...
    },
    {
      ...
      projects: [
        { name: 'TOMS Platform', hours: 30, color: '#6366f1' },
    ...
    },
    {
      ...
      allocated: 20,
      availability: 'available',
      projects: [{ name: 'API Development', hours: 20, color: '#10b981' }],
    },
    {
      id: '4',
      name: 'Michael Brown',
      ...
      projects: [
        { name: 'TOMS Platform', hours: 15, color: '#6366f1' },
        ...
        <div className="mb-6 flex items-center justify-between">
          <div>
            <div className="flex items-center gap-2 mb-2">
              ...
              <h2 className="text-lg font-semibold text-[#111] dark:text-[#e5e5e5]">Resource Planning</h2>
            </div>
      ...
      <div className="grid grid-cols-4 gap-4">
        <div className="bg-white dark:bg-[#1e1e1e] rounded-lg border border-[rgba(0,0,0,0.05)] dark:border-[rgba(255,255,255,0.1)] p-5">
          <div className="flex items-start justify-between mb-2">
            <span className="text-[10px] text-[#666] dark:text-[#888] font-medium tracking-wide uppercase">Total Resources</span>
        ...
        <div className="bg-white dark:bg-[#1e1e1e] rounded-lg border border-[rgba(0,0,0,0.05)] dark:border-[rgba(255,255,255,0.1)] p-5">
          <div className="flex items-start justify-between mb-2">
            <span className="text-[10px] text-[#666] dark:text-[#888] font-medium tracking-wide uppercase">Total Capacity</span>
        ...
        <div className="bg-white dark:bg-[#1e1e1e] rounded-lg border border-[rgba(0,0,0,0.05)] dark:border-[rgba(255,255,255,0.1)] p-5">
          <div className="flex items-start justify-between mb-2">
            <span className="text-[10px] text-[#666] dark:text-[#888] font-medium tracking-wide uppercase">Allocated</span>
        ...
        <div className="bg-white dark:bg-[#1e1e1e] rounded-lg border border-[rgba(0,0,0,0.05)] dark:border-[rgba(255,255,255,0.1)] p-5">
          <div className="flex items-start justify-between mb-2">
            <span className="text-[10px] text-[#666] dark:text-[#888] font-medium tracking-wide uppercase">Utilization</span>
